...
const BackgroundCircle = ({ }: Props) => {
    return (
        <motion.div
            ...
            <div className='absolute border border-[#2a27d2] rounded-full h-[200px] w-[200px] mt-52 animate-ping' />
            <div className='rounded-full border border-[#333333]  h-[300px] w-[300px] absolute mt-52 ' />
            {/* <div className='rounded-full border border-[#499619]  h-[500px] w-[500px] absolute mt-52 ' /> */}

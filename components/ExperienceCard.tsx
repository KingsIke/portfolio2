...
const ExperienceCard = ({ }: Props) => {
    return (
        <article className=' mt-24 h-2/3 w-fit space-y-1 sm:mt-0 sm:flex sm:flex-col  rounded-lg item-center sm:space-y-7 flex-shrink-0 sm:w-[400px] sm:h-fit  md:w-[500px] xl:w-[600px] snap-center bg-[#421f6f]   hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden '>
            <motion.img
                initial={{
                    y: -100,
                    opacity: 0
...
//     < article className = ' mt-10 h-2/3 w-full sm:mt-0 sm:flex sm:flex-col  rounded-lg item-center space-y-7 flex-shrink-0 sm:w-[400px] sm:h-fit  md:w-[500px] xl:w-[600px] snap-center bg-[#421f6f]   hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden ' >
// <motion.img
//     initial={{
//         y: -100,
//         opacity: 0
...
//     viewport={{ once: true }}
//     src="https://avatars1.githubusercontent.com/u/54376835?s=200&v=4"
//     className='w-10 h-1 mt-0 sm:w-20 sm:h-20 sm:ml-40 sm:mt-3 rounded-full xl:w-[100px] xl:h-[100px] object-cover object-center bg-[#27c64c]' alt="" />
...
//     <ul className='space-y-0 sm:text-sm sm:space-y-0 list-disc xl:space-y-4 ml-5 xl:text-md'>
//         <li>Summary PointsSummary  PointsSummary Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga est ratione assumenda optio corrupti vel ipsam doloremque quas magni illu Points</li>
//         <li>Summary PointsSummary PointsSummary Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga est ratione assumenda optio corrupti vel ipsam doloremque quas magni illu Points</li>
//         <li>Summary PointsSummary PointsSummary Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga est ratione assumenda optio corrupti vel ipsam doloremque quas magni illu Points</li>
//         <li>Summary PointsSummary PointsSummary  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga est ratione assumenda optio corrupti vel ipsam doloremque quas magni illuPoints</li>

...
const Projects = ({ }: Props) => {
    ...
    return (
        <div className='h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0 space-y-30'>
                ...
                {projects.map((project, i) => {
                    return (
                        ...
                        <div className="w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen">
                            <img src="https://www.oberlo.com/media/1603969791-image-1.jpg?fit=max&fm=webp&w=1824" className="h-3/6 w-2/6 sm:h-2/6 sm:w-2/6 " alt="" />
